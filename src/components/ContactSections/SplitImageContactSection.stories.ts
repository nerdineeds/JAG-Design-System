// SplitImageContactSection.stories.tsx

import type { Meta, StoryObj } from '@storybook/react';
import SplitImageContactSection from './SplitImageContactSection'; // Replace with the path to your component

// Meta configuration for Storybook
const meta: Meta<typeof SplitImageContactSection> = {
  title: 'Sections/Contact/SplitImageContactSection', // Set the appropriate path in the Storybook hierarchy
  component: SplitImageContactSection,
