...
import ContentSection from './ContentSection'; // Replace with the path to your component

// Meta configuration for Storybook
const meta: Meta<typeof ContentSection> = {
  title: 'Sections/Content/ContentSection', // Set the appropriate path in the Storybook hierarchy
