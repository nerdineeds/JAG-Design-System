// TwoColumnScreenshot.stories.tsx

import type { Meta, StoryObj } from '@storybook/react';
import TwoColumnScreenshot from './TwoColumnScreenshot'; // Replace with the path to your component

// Meta configuration for Storybook
const meta: Meta<typeof TwoColumnScreenshot> = {
  title: 'Sections/Content/TwoColumnScreenshot', // Set the appropriate path in the Storybook hierarchy
  component: TwoColumnScreenshot,
